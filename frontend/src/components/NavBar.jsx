                ...
                <header className={`py-2 px-4 md:px-10 border-b ${isDark ? 'bg-dark-container border-gray-500' : 'bg-light-container'}`}>
                    <nav className="flex justify-between items-center w-full gap-3">
                        ...
                        <div className='flex justify-center items-center gap-3'>
                            <button className='bg-purple-600 rounded-md px-4 py-2 text-white hover:bg-purple-700'>Login</button>
                            <button className='bg-purple-600 rounded-md px-4 py-2 text-white hover:bg-purple-700'>Sign-up</button>
                        </div>
                    </nav>
                </header >
            )}
